...
class AppRoutes {
  ...
  static const String deviceDetail = '/deviceDetail'; // ✅ New route
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    lostFound: (context) => const LostAndFoundPage(),
    // Optional: use if navigating via named route
    // deviceDetail: (context) => DeviceDetailPage(), // Requires parameters
  };
}
